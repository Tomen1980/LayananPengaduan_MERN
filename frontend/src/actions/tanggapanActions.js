...
export const statusTanggapan = (tanggapans) => async(dispatch, getState)=>{
    try {
        ...
        const {data} = await axios.put(`/api/pengaduan/${tanggapans._id}/validasi`,tanggapans,config)
...
export const addTanggapan = (report) => async(dispatch, getState)=>{
    try {
        ...
        const {data} = await axios.post(`/api/tanggapan/${report._id}/tanggapi`, report, config)
