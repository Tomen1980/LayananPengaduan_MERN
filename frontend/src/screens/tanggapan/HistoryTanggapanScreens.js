...
import {listTanggapanPetugas,deleteTanggapanAdmin} from '../../actions/tanggapanActions'

const HistoryTanggapanScreens = ({history}) => {
...
export default HistoryTanggapanScreens
